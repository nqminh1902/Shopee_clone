...
if (isset($_GET['edit_id'])) {
    $sql_query = "SELECT * FROM danhmucsp WHERE iddanhmuc=" . $_GET['edit_id'];
...
if (isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE danhmucsp SET tendanhmuc='$name' WHERE iddanhmuc=" . $_GET['edit_id'];
    // sql query for update data into database
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="content">
                                        <form method="post">
                                            <table align="center">
                                                <tr>
                                                    <td><input type="text" name="tendanhmuc" placeholder="Danh muc"
                                                            value="<?php echo $fetched_row['tendanhmuc']; ?>"
                                                            required />
                                                    </td>
                                                </tr>
