...
if (isset($_GET['edit_id'])) {
    $sql_query = "SELECT * FROM khachhang WHERE idkh=" . $_GET['edit_id'];
...
if (isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE khachhang SET hoten='$name',sdt='$number',diachi='$address',email='$email' WHERE idkh=" . $_GET['edit_id'];
    // sql query for update data into database
                ...
                <div class="start">
                    <nav class="navbar navbar-light bg-light">
                        <div class="container-fluid">
                            <p class="navbar-brand mb-0 h1">Danh sách Khách Hàng</p>
                        </div>
                    </nav>
                </div>
                <div class="row mt">
