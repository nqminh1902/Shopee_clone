...
if (isset($_POST['btn-update'])) {
    ...
    if ($hinhanh != '') {
        ...
        $sql_query = "UPDATE sanpham SET idsp= '$id',tensp='$name',dongia='$price',hinhanh='$hinhanh',iddanhmuc='$danhmuc',chitiet='$chitiet',soluong='$soluong',mota='$mota' WHERE idsp=" . $_GET['edit_id'];
        ...
        $sql_query = "UPDATE sanpham SET idsp= '$id',tensp='$name',dongia='$price',iddanhmuc='$danhmuc',chitiet='$chitiet',soluong='$soluong',mota='$mota' WHERE idsp=" . $_GET['edit_id'];
    }
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="content">
                                        <form method="post" enctype="multipart/form-data">
                                            <table align="center">
                                                <tr>
                                                    <td><input type="text" name="id" placeholder="id San phẩm"
                                                            value="<?php echo $fetched_row['idsp']; ?>" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img src="../admin/uploads/<?php echo $fetched_row['hinhanh'] ?>"
                                                            width="150px">
                                                    </td>
                                                </tr>
                                                <tr>
