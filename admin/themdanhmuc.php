...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO danhmucsp(tendanhmuc) VALUES('$name')";
    // sql query for inserting data into database
                ...
                <div class="start">
                    <nav class="navbar navbar-light bg-light">
                        <div class="container-fluid">
                            <p class="navbar-brand mb-0 h1">Thêm danh muc sản phẩm</p>
                        </div>
                    </nav>
                </div>
                <div class="row mt">
                                    ...
                                    <div id="content">
                                        <form method="post">
                                            <table class="main_table" align="center">
                                                <tr>
                                                    <td align="center"><a href="danhmucsp.php">Quay trở về</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><input type="text" name="tendanhmuc" placeholder="Danh mục"
                                                            required />
                                                    </td>
                                                </tr>
