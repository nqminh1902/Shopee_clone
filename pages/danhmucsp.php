<div class="grid__column-10">
    ...
    <div class="home-product">
        ...
        <div class="grid__row">
            <?php
            $sql_pro = "SELECT * FROM sanpham WHERE sanpham.iddanhmuc='$_GET[iddanhmuc]' ORDER BY idsp DESC";
            ...
            <div class="grid__column-2-4">
                <!-- Product item -->
                <a class="home-product-item" href="index.php?trang=chitetsp&idsp=<?php echo $row_pro['idsp'] ?>">



                    <div class="home-product-item_img"
                        style="background-image: url(./admin/uploads/<?php echo $row_pro['hinhanh'] ?>);">
                    </div>
                    <h4 class="home-product-item_name"><?php echo $row_pro['tensp'] ?></h4>
                    <div class="home-product-item__price">
                        <span class="home-product-item__price-old">1.200.000đ</span>
                        <span
                            class="home-product-item__price-sale"><?php echo number_format($row_pro['dongia'], 0, ',', '.') . 'đ'; ?></span>
                    </div>
